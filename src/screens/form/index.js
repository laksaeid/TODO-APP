    ...
    E({
      ...
      child: [
        E({
          tag: 'select',
          id: "priority",
          className: "block flex-1 py-2.5 px-0 w-full text-sm text-gray-500 w-28 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer",
          child: [E({
            tag: 'option',
          ...
          tag: 'select',
          id: "status",
          className: "block flex-1 py-2.5 px-0 mx-10 w-full text-sm text-gray-500 w-28 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer",
          child: [E({
            tag: 'option',
            restAttr:{"selected":'',"hidden":''},
            child:'Status'
      ...
      E({
        ...
        id: "message",
        rows: "4",
        className: "mt-10 max-h-[150px] block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ,placeholder:"Write your thoughts here..." 
      }),
      FormFooter()
    ]
  });
